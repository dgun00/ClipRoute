...
public class CourseConverter {
    ...
    public static CourseResDTO.CoursePublicListDTO toCoursePublicListDTO(
            List<CourseResDTO.CoursePublicDTO> courses, SliceInfoDTO courseInfoDTO,  Long totalElements, String sort
    ) {
    ...
    public static CourseResDTO.ScrapResultDTO toScrapResult(
            Long newCourseId, Long originalCourseId, MemberCourse mc
    ) {
